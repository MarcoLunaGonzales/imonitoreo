...
$moduleName="Ejecucion POAI Detallado por Actividad";
...
<div class="content">
  <div class="container-fluid">
      ...
      <div class="card">
        ...
        <div class="card-body ">
          <?php
          $sqlLista="SELECT distinct(a.codigo)as codigo, a.orden, a.nombre, a.cod_tiporesultado, a.cod_unidadorganizacional, a.cod_area, (SELECT h.nombre from hitos h where h.codigo=a.cod_hito)as hito, (SELECT i.nombre from indicadores i where i.codigo=a.cod_indicador)as indicador, a.cod_indicador, (SELECT s.nombre from sectores_economicos s where s.codigo=a.cod_normapriorizada) as sector, 
            (select p.nombre from personal2 p where p.codigo=a.cod_personal)as responsable, a.cod_actividadpadre, 
            (select cf.nombre_funcion from cargos_funciones cf where cf.cod_funcion=a.cod_funcion)as funcion
            ...
            and a.poai=1 order by hito, a.cod_unidadorganizacional, a.cod_area, indicador, a.nombre";
          ...
          $stmtLista->bindColumn('responsable', $nombreResponsable);
          $stmtLista->bindColumn('cod_actividadpadre', $actividadPadre);
          $stmtLista->bindColumn('funcion', $funcionCargo);
                    ...
                    <table class="table table-condensed" id="tablePaginatorReport">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">CodPadre</th>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-left font-weight-bold small"><?=$nombreResponsable;?></td>
                          <td class="text-left font-weight-bold small"><?=$actividadPadre;?></td>
                          <td class="text-left font-weight-bold small"><?=$funcionCargo;?></td>
                        <?php
                          $totalPlani=0;
                          $totalEje=0;
                          for($i=1;$i<=12;$i++){
