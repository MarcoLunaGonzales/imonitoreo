...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="reportes/rptEjecucionPOAIDetalle.php" method="post" target="_blank">
		  	<input type="hidden" name="cod_objetivo" value="<?=$codigoObjetivo?>">
			<div class="card ">
			  <div class="card-header <?=$colorCard;?> card-header-text">
				<div class="card-text">
				  <h4 class="card-title">Reporte Ejecucion POAI Detallado Por Actividad</h4>
				</div>
			  </div>
			  <div class="card-body ">
