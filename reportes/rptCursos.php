...
$tipoCursosString=implode(",", $tipoCursos);
...
e.id_oficina=u.codigo and p.codigo=e.id_programa and year(e.fecha_inicio)='$nameGestion' and month(e.fecha_inicio) in ($mesString) and e.id_oficina in ($unidadOrgString) and e.tipo in ($tipoCursosString) order by unidad, e.fecha_inicio, nombreprograma";
