...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="versiones_poa/save.php" method="post">
			<div class="card ">
			  ...
			  <div class="card-footer ml-auto mr-auto">
				...
				<a href="?opcion=versionarPOA" class="btn btn-danger">Cancelar</a>
			  </div>
			</div>
		  </form>
		</div>
