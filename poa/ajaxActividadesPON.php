...
<div class="col-md-12">
	<div class="row">
		...
		<div class="col-sm-4">
	        ...
	        <select class="selectpicker" name="comite<?=$codigo;?>" id="comite<?=$codigo;?>" data-style="<?=$comboColor;?>" data-live-search="true">
	    ...
	    <div class="col-sm-4">
	    	<div class="form-group">
	        <select class="selectpicker" name="modogeneracion<?=$codigo;?>" id="modogeneracion<?=$codigo;?>" data-style="<?=$comboColor;?>" data-live-search="true">
...
<div class="col-md-12">
	<div class="row">
        ...
        <div class="col-sm-4">
        	<div class="form-group">
	        <select class="selectpicker" name="estadopon<?=$codigo;?>" id="estadopon<?=$codigo;?>" data-style="<?=$comboColor;?>">
