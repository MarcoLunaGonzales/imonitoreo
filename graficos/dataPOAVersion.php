...
$codVersionTemporal=$_GET["codVersionX"];
...
require_once '../styles.php';
	...
	for($i=1;$i<=12;$i++){
		$planificadoMesVersion=planificacionPorIndicadorVersion($codIndicador,$codAreaTemporal,$codUnidadTemporal,$i,0,$codVersionTemporal);
		$planificadoMes=planificacionPorIndicador($codIndicador,$codAreaTemporal,$codUnidadTemporal,$i,0);
	  	...
	  	$abrevMes=abrevMes($i);
	  	$emparray[]=array("area"=>$codAreaTemporal,"unidad"=>$codUnidadTemporal,"mes"=>$abrevMes, "presupuesto"=>$planificadoMes, "ejecutado"=>$ejecutadoMes, "presupuestoversion"=>$planificadoMesVersion);
	}
