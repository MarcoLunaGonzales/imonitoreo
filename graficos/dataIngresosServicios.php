...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
	...
	$nombreOrganismo=$row['nombre'];
  	...
  	$montoPresIngreso=round(presupuestoIngresosMes($cadenaFondos,$anioTemporal,$mesTemporal,$codOrganismo,0,0),2);
	$montoEjIngreso=round(ejecutadoIngresosMes($cadenaFondos,$anioTemporal,$mesTemporal,$codOrganismo,0,0),2);
