...
$emparray[]=array("gestion"=>$anioTemporalAnt, "montoPresIngreso"=>$montoPresIngresoAnt, "montoEjIngreso"=>$montoEjIngresoAnt,"montoPresEgreso"=>$montoPresEgresoAnt,"montoEjEgreso"=>$montoEjEgresoAnt,"resultadoPres"=>$resultadoPresAnt,"resultadoEj"=>$resultadoEjAnt);

$emparray[]=array("gestion"=>$anioTemporal, "montoPresIngreso"=>$montoPresIngreso, "montoEjIngreso"=>$montoEjIngreso,"montoPresEgreso"=>$montoPresEgreso,"montoEjEgreso"=>$montoEjEgreso,"resultadoPres"=>$resultadoPres,"resultadoEj"=>$resultadoEj);
