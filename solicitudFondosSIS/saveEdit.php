...
$stmt = $dbh->prepare("UPDATE solicitud_fondos set fecha='$fecha', observaciones='$observaciones' where codigo='$codigo'");
$flagSuccess=$stmt->execute();	


$stmt = $dbh->prepare("DELETE from solicitudfondos_detalle where codigo='$codigo'");
$flagSuccess=$stmt->execute();	
