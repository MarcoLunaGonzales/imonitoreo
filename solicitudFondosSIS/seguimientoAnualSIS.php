...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="col-md-12">
      <form id="form1" class="form-horizontal" action="solicitudFondosSIS/rptSeguimientoAnualSIS.php" method="get" target="_blank">
      <div class="card ">
        <div class="card-header <?=$colorCard;?> card-header-text">
        <div class="card-text">
          <h4 class="card-title">Seguimiento Detallado de Proyectos</h4>
        </div>
        </div>
        <div class="card-body ">
          <div class="row">
