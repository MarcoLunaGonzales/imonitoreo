...
// Preparamos
$sql="SELECT s.codigo, (SELECT g.nombre from gestiones g where g.codigo=s.cod_gestion)as gestion, s.fecha, s.observaciones, (SELECT sum(sd.monto) from solicitudfondos_detalle sd where sd.codigo=s.codigo)as monto from $table s where s.cod_gestion='$globalGestion' and s.cod_estado=1 order by s.fecha";
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Detalle Solicitud de Fondos</h4>
