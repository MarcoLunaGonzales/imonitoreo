...
while($row = $stmt -> fetch(PDO::FETCH_BOUND)){
	$montoServicio=serviciosPorUnidadTCP($cadenaUnidades,$codAreaTemporal,$anioTemporal,$mesTemporal,0,$codigoServicio,2);
	$montoServicioAcum=serviciosPorUnidadTCP($cadenaUnidades,$codAreaTemporal,$anioTemporal,$mesTemporal,1,$codigoServicio,2);
