          ...
          <div class="card">
            ...
            <div class="card-body">
              <table width="100%" class="table table-condensed" id="main">
                ...
                <tbody>
                  <?php
                  $sql="SELECT sd.codigo, sd.nombre, sum(e.cantidad)as totalCantidadServicios, sum(e.monto_facturado)as montoTotalFactura from ext_servicios e, $tablaServiciosDet sd, $tablaServicios so where so.codigo=sd.cod_servicio and e.idclaservicio=sd.codigo and YEAR(e.fecha_factura)=$anioTemporal and MONTH(e.fecha_factura)=$mesTemporal and so.codigo=$codServicio group by sd.codigo, sd.nombre order by 4 desc";
