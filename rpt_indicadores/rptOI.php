              ...
              <table width="100%" class="table table-condensed" id="main">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-left"><a href="rptOIDetalle.php?codArea=<?=$codArea;?>&codServicio=<?=$codigoServicio;?>&mes=<?=$mesTemporal;?>&anio=<?=$anioTemporal;?>" target="_blank"><?=$nombreServicio;?></a></td>
                    <?php
                    $stmtU->execute();
                    while($rowU = $stmtU -> fetch(PDO::FETCH_BOUND)){
                      $cantidadServicios=serviciosPorUnidad($codigoX,$anioTemporal,$mesTemporal,0,$codigoServicio,1);
                      $montoServicios=serviciosPorUnidad($codigoX,$anioTemporal,$mesTemporal,0,$codigoServicio,2);
                    ?>
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              $anioX=$anioTemporal;
              $mesX=$mesTemporal;
              require("chartServiciosOINivel1.php");
              ?>
            </div>
          </div>
        </div>
