...
while($resp = $query->fetch()){
	...
	$insert_str .= "('$IdSolicitudFactura','$Fecha','$año','$GranDetalle','$NombreContacto','$NombreContactoAdmin','$Telefono','$Direccion','$Email','$idObjeto','$IdCliente','$NombreFactura','$NIT','$Observacion','$d_usuario','$d_oficina','$d_tipoobjeto','$d_area','$d_cliente','$idestado','$d_estado','$fechaEstado','$Estado_obs','$d_formaPago','$CodigoServicioCurso','$d_ServicioCurso','$detalle','$Cantidad','$Precio','$montobs'),";	
