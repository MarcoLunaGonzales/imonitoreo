...
while ($rowCarga = $stmtCarga->fetch(PDO::FETCH_ASSOC)) {
	...
	$stmtDelOficial = $dbh->prepare("DELETE FROM actividades_poa where cod_indicador='$codIndicadorX' and cod_unidadorganizacional='$codUnidadX' and cod_area='$codAreaX'");
