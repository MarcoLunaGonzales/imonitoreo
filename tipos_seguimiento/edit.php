...
$moduleName="Tipo de Seguimiento";
...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="tipos_seguimiento/saveEdit.php" method="post">
			...
			<div class="card ">
			  ...
			  <div class="card-footer ml-auto mr-auto">
				...
				<a href="?opcion=listTiposSeg" class="<?=$buttonCancel;?>">Cancelar</a>
			  </div>
			</div>
		  </form>
		</div>
