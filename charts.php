        ...
        <div class="container-fluid">
          <div class="container-fluid">
            <div class="header text-center">
              ...
              <p class="category">Sistema de Monitoreo y Control
              </p>
            </div>
            <div class="row">
              <div class="col-md-4">
                <div class="card card-chart">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Cant. Servicios implementados en base a una norma</h4>
              ...
              <div class="col-md-4">
                <div class="card card-chart">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">% Cumplimiento del POA</h4>
              ...
              <div class="col-md-4">
                <div class="card card-chart">
                  ...
                  <div class="card-body">
                    <h4 class="card-title ">Procesos Informatizados</h4>
