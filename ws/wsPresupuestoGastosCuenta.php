...
// recoveri variable
	...
	if(isset($datos['sIdentificador'])){
		...
		$presupuestoGastos=presupuestoEgresosMes($fondos, $anioX, $mesX, $organismos, 1, $cuentaX);
		$ejecutadoGastos=ejecutadoEgresosMes($fondos, $anioX, $mesX, $organismos, 1, $cuentaX);
