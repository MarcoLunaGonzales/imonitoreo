...
$moduleName="Registrar Gestion Extendida";
...
<div class="content">
	<div class="container-fluid">
		...
		<div class="col-md-12">
		  <form id="form1" class="form-horizontal" action="gestiones_extendidas/save.php" method="post">
          ...
          <div class="form-group">
            <select class="selectpicker" title="Seleccionar" name="gestion" id="gestion" data-style="btn btn-rose" required>
              ...
              <?php
              $stmt = $dbh->prepare("SELECT g.codigo, g.nombre FROM gestiones g where g.codigo not in (SELECT id_gestion from gestiones_extendidas) order by 2 desc");
            $stmt->execute();
