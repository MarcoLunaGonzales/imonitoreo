...
(select count(*) from areas_poa apoa where u.codigo=apoa.cod_area)as bandera 
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <form method="post" action="areas/saveAreaPOA.php">
                    <table class="table">
                      <thead>
                        <tr>
                        ...
                        <tr>
                          ...
                          <div class="form-check">
                            <label class="form-check-label">
                              <input class="form-check-input" type="checkbox" name="areaspoa[]" value="<?=$codigo?>" <?=($bandera>0)?"checked":"";?> >
