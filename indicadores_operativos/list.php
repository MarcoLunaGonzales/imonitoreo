...
$table="indicadores";
$moduleName="Indicadores Operativos";
...
FROM indicadores i WHERE i.cod_objetivo='$codigoObjetivo' ORDER BY i.nombre";
	...
	<div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header <?=$colorCard;?> card-header-icon">
                  ...
                  <h6 class="card-title">Objetivo Operativo: <?=$nombreObjetivo?></h6>
                </div>
                <div class="card-body">
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="td-actions text-right">
                            <a href='' rel="tooltip" class="<?=$buttonEdit;?>" title="En Construccion">
                              <i class="material-icons">edit</i>
                            </a>
                            <button rel="tooltip" class="btn btn-danger" onclick="alerts.showSwal('warning-message-and-confirmation','index.php?opcion=deleteIndicadorOp&codigo=<?=$codigo;?>')">
            ...
            ?>
				...
				<div class="card-body">
                    <button class="<?=$button;?>" onClick="location.href='index.php?opcion=registerIndicadorOp&codigo=<?=$codigoObjetivo?>'">Registrar</button>
                    <a href="?opcion=listObjetivosOp" class="<?=$buttonCancel;?>">Cancelar</a>  
                </div>
            </div>
          </div>  
        </div>
