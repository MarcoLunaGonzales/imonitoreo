...
// Prepare
$stmt = $dbh->prepare("UPDATE $table set nombre=:nombre, cod_perspectiva=:cod_perspectiva, abreviatura=:abreviatura, descripcion=:descripcion,  modified_at=:modifiedAt, modified_by=:modifiedBy where codigo=:codigo");
// Bind
