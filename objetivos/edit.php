...
$codigo=$codigo;
$stmt = $dbh->prepare("SELECT codigo, nombre, cod_perspectiva, abreviatura, descripcion FROM $table where codigo=:codigo");
// Ejecutamos
			...
			<div class="card ">
			  ...
			  <div class="card-body ">
				...
				<div class="row">
				  ...
				  <div class="col-sm-7">
					<div class="form-group">
					  <input class="form-control" type="text" name="abreviatura" id="abreviatura" required="true" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?=$abreviaturaX;?>"/>
					</div>
				  </div>
				</div>
